...
$redirect_url = isset($_SESSION['user_id']) && $_SESSION['role'] === 'family'
    ? '/elderly-care-system/user/index.php'
...
<head>
    ...
    <title>Error - Family Portal</title>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="error-container">
                    ...
                    <p class="mb-4">Sorry, something went wrong in the family portal. Please try again later.</p>
