...
$redirect_url = isset($_SESSION['user_id']) && $_SESSION['role'] === 'admin' 
    ? '/elderly-care-system/admin/dashboard.php' 
...
<head>
    ...
    <title>Unauthorized Access - Admin Portal</title>
...
<body>
    <div class="error-container">
        ...
        <p class="mb-4">You do not have permission to access this page. Please ensure you are logged in with administrator credentials.</p>
        <a href="<?php echo htmlspecialchars($redirect_url); ?>" class="btn btn-primary">
            <i class="fas fa-arrow-left me-2"></i>Return to <?php echo isset($_SESSION['user_id']) && $_SESSION['role'] === 'admin' ? 'Dashboard' : 'Login'; ?>
        </a>
    </div>
