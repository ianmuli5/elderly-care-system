...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Check if email exists for a staff user
    $query = "SELECT u.user_id, u.username FROM users u JOIN staff s ON u.user_id = s.user_id WHERE u.email = $1 AND u.role = 'staff'";
    ...
    if (pg_num_rows($result) === 1) {
        ...
        $message = "Hello,\n\nA password reset was requested for your staff account. If you did not request this, you can ignore this email.\n\nTo reset your password, click the link below (valid for 3 hours):\n$reset_link\n\nThank you.";
