                ...
                <div class="card family-card h-100">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2 mt-3">
                            ...
                            <?php if ($relative['caregiver_id'] && isset($caregiver) && $caregiver): ?>
                                <a href="messages.php?user=<?php echo $relative['caregiver_id']; ?>" class="btn btn-outline-primary">Contact Caregiver</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><span class="badge <?php echo $alert_class; ?>"><?php echo ucfirst($alert['level']); ?></span></td>
