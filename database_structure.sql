...
-- If table already exists, use ALTER TABLE for migration
ALTER TABLE staff ADD COLUMN IF NOT EXISTS national_id VARCHAR(30);
ALTER TABLE staff ADD COLUMN IF NOT EXISTS date_of_employment DATE;
ALTER TABLE staff ADD COLUMN IF NOT EXISTS work_permit_number VARCHAR(30);
...
-- Add new fields for resident registration (2024 update)
ALTER TABLE residents
    ...
    ADD COLUMN primary_doctor VARCHAR(100),
    ADD COLUMN primary_doctor_other VARCHAR(100),
    ADD COLUMN religion VARCHAR(30),
    ADD COLUMN religion_other VARCHAR(50),
    ADD COLUMN marital_status VARCHAR(20),
    ADD COLUMN spouse_name VARCHAR(100),
    ADD COLUMN spouse_contact VARCHAR(30),
    ADD COLUMN children_info TEXT,
    ADD COLUMN next_of_kin_name VARCHAR(100),
    ADD COLUMN next_of_kin_contact VARCHAR(30);

-- Note: admission_date already exists, ensure it is displayed in the UI (profile/table)
...
CREATE TABLE feedback (
    ...
    response_status VARCHAR(20) DEFAULT 'pending', -- 'pending', 'responded'
